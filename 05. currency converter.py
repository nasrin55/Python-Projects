...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text='Welcome to '
        ...
        self.date_label = Label(self,
                                text=f"1 Bangladeshi taka equals = {self.currency_converter.convert('BDT', 'USD', 1)} USD \n Date : {self.currency_converter.data['date']}",
        ...
        self.amount_field = Entry(self, bd=3,
                                  relief=tk.RIDGE,
                                  justify=tk.CENTER,
                                  validate='key',
